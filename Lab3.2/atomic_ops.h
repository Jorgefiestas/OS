...
static inline void tatas_backoff_acquire_slowpath(tatas_lock_t* L)
{
    int b = 64;
...
static inline void tatas_backoff_acquire(tatas_lock_t* L)
{
    if (tas(L))
        tatas_backoff_acquire_slowpath(L);
}
